---
title: Ruby On Rails Getting Started Book
tags: 
  - ruby-on-rails
categories: 
  - old-archive
...
The first operating system we'll run you through is Mac OS X 10.4 Tiger, which is the predominant development environment for Ruby on Rails at this time, later on in the chapter we'll move on to other operating systems. There are many different ways you can get going with Rails on Mac OS X, the simplest would be to use the Locomotive that you can download from [their site](http://locomotive.raaum.org/) which is a complete Ruby on Rails development environment in one easy to use application. However, if you're looking for something more permanent I recommend the following approach.
...
The easiest way to get going with Darwin Ports is to download the Universal Binary installer and run it, which you can get from [DarwinPorts](http://darwinports.org/getdp/). Once you've downloaded the image you need to mount it and run the installer within. I assume you're on a clean install with the latest updates, which as I write this chapter is Mac OS X 10.4.7. Open the Terminal application and prepare to get dirty. We need to adjust our shell settings to use our new ports installed applications before it attempts to use the built in (usually broken) ruby version.

    $ sudo vi /etc/profile

You'll be prompted for your password and will be shown the content of the global profile configuration file. Every time you open a terminal Mac OS X runs this to set up variables and globals that it will need. We need to add our new Darwin ports installation directory /opt/local/bin to the beginning of the path so that the ports folder has priority over the default Mac OS X folder. If you're not familiar with the vi editor, don't worry I'll run you through this bit in small steps. There are different modes of use in vi, and we need to 'insert' into the file.
...
Figure 1-1 ![Figure 1-1](http://www.fearoffish.co.uk/assets/2006/10/24/f0101.jpg)
...
Figure 1-2 ![Figure 1-2](http://www.fearoffish.co.uk/assets/2006/10/24/f0102.jpg)
...
Figure 1-3 ![Figure 1-3](http://www.fearoffish.co.uk/assets/2006/10/24/f0103.jpg)
...
Figure 1-4 ![Figure 1-4](http://www.fearoffish.co.uk/assets/2006/10/24/f0104.jpg)
...
Figure 1-5 ![Figure 1-5](http://www.fearoffish.co.uk/assets/2006/10/24/f0105.jpg)
...
Note: This is borrowed from [Ruby on Rails Screencasts](http://www.rubyonrails.org/screencasts)
...
That's our Rails application created, next we'll be needing a database to store our blog posts in and we'll need to tell Rails where it is and how to access it.
    ...
    $ mysqladmin Ðu root Ðp create blog_development
...
Figure 1.6 ![Figure 1-6](http://www.fearoffish.co.uk/assets/2006/10/24/f0106.jpg)

Obviously that's no use to us, so let's not waste any time at all, and we'll fire in and edit the files. Don't worry if you don't understand why or what we're doing, just follow the instructions and you'll end up with an application and a basic understanding of the overall development process in Rails. We'll start using the Rails generators now, firstly we need a model to handle our posts. The model uses ActiveRecord to interact with our database, in this case the posts table which we need to create.
...
Figure 1.7 ![Figure 1-7](http://www.fearoffish.co.uk/assets/2006/10/24/f0107.jpg)

Figure 1.8 ![Figure 1-8](http://www.fearoffish.co.uk/assets/2006/10/24/f0108.jpg)

Figure 1.9 ![Figure 1-9](http://www.fearoffish.co.uk/assets/2006/10/24/f0109.jpg)

Figure 1.10 ![Figure 1-10](http://www.fearoffish.co.uk/assets/2006/10/24/f0110.jpg)
...
File: app/controllers/blog\_controller.rb
...
Figure 1.11 ![Figure 1-11](http://www.fearoffish.co.uk/assets/2006/10/24/f0111.jpg)Figure 1.12 ![Figure 1-12](http://www.fearoffish.co.uk/assets/2006/10/24/f0112.jpg)
